    ...
    <div class="container">    
        <div class="row justify-content-md-center"> 
            <form action="report.php" method="post" class="row g-1">   
                    ...
                    <?php 
                        ...
                        //***User with more stations gets to choose what station does the report refer to********************************************
                            ...
                            foreach($locations_id as $row) {
                                ...
                                echo '<br>';//#########################TEMP################################
                                echo 'station with id '.$loc_data['id'].' nicknamed '.$loc_data['nickname'];
                                echo '<br>';
                                echo '
                                    <div class="mb-2">            
                ...
                <div class="row content-md-center text-center">
        ...
        <?php
            ...
            //TODO->Find a better way of calling swal (js function) in php if clause%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            $on_inser_success = false;
            $on_inser_error = false;
            ...
            //             alert_location_info('.$loc_data['nickname'], $loc_data['region_id'],$loc_data['district_id'],$loc_data['town_id'].')
            //          </script>'; 
