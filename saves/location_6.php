                ...
                <div class="row justify-content-md-center">
                    ...
                    <form action = "location.php" method = "GET">
                        <div class="mt-3">
                            ...
                            <input class="form-control"  value="<?php echo $_GET['region'] ??''; ?>"  list="region" id="region_dselect" 
                    ...
                    <?php
                        ...
                        if(isset($_GET['region']) || isset($_SESSION['input_region_name'])) {
                            $district_disabled = '';
                        }
                    ?>
                    <!-- ***District input******************************************************************************************************* -->
                    ...
                    <?php
                        ...
                        if(isset($_GET['district']) || isset($_SESSION['input_district_name'])) {
                            $town_disabled = '';
                        }
                    ?>
                    <!-- ***Town input*********************************************************************************************************** -->
